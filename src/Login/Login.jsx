...
function Login() {
  return (
    <>
      {/* <div className='login_page' style={{ width: '100%', height: '130vh' }}>
        <Container >
          <div className='shadow rounded login_body d-flex justify-content-center align-items-center'>
            <Row>
              <Col md={12}>
                <div >
                  <Row>
                    ...
                    <Col md={6}>
                      <div className='mt-4 me-3 rounded' style={{ height: '500px', backgroundColor: 'white' }}>
                        ...
                        <div className='d-flex justify-content-center align-items-center flex-row '>
                          <div className='google d-flex justify-content-evenly rounded' style={{ width: '50%'}}>
                            <img className='ms-4 mt-2 me-1' src={google} style={{ width: '25px'}} alt="" />
  ...
  <div className='login_page'>
    <Row className='mt-5'>
      <Col md={1}></Col>
      <Col md={10} className='mt-5 d-flex justify-content-center align-items-center'>
        <div className='shadow rounded login_body p-4' style={{ width: '75%', maxWidth: '1000px', backgroundColor: 'white' }}>
          <Row>
          <Col md={6} className='order-md-1'>
              ...
              <div className='mt-2 d-flex justify-content-center align-items-center'>
                <img src="https://media.istockphoto.com/id/1341609914/vector/pregnant-couple-background-vector-illustration-with-a-husband-takes-care-and-hugs-his-wife.jpg?s=612x612&w=0&k=20&c=IZ7k7IktzY_x61KybAj2yBioHTLk6r86jafhB3ExN0E=" style={{ maxWidth: '100%', height: 'auto', borderRadius: '50%' }} alt="" />
              </div>
              <div className=' d-flex justify-content-center align-items-center mt-3 ms-3'>
                <p style={{ fontWeight: 'bold', color: 'blueviolet' }}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officiis, dignissimos amet hic sed iusto illum similique sit, animi quam </p>
              </div>
